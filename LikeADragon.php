...
<html>
  ...
  <body>
  <h1 class="burning">4.9/5.0</h1> 
  <h1 class="burning">Yakuza Like A Dragon</h1> 
  <h2 class="burning">"When it's time to throw down, my brain just starts thinking in Dragon Quest Terms"</h2>
		<div class ="profile">
		 <h3> Profile </h3>
