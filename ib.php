...
<html>
  ...
  <h1 class="burning">Inglourious Bastards</h1> 
  <h2 class="burning">Oooh, that's a bingo!"</h2>
		<div class ="profile">
		 <h3> Profile </h3>
	   ...
	   <div id="menu">
		...
		<div class = "main_content">
				...
				<div class = "description">
					<p>It is the first year of Germany's occupation of France. 
					Allied officer Lt. Aldo Raine (Brad Pitt) assembles a team of Jewish soldiers to commit violent acts of retribution</p>					
					<div class = "list">
					<ul>
						<li>Director: Quentin Tarantino</li>
						<li>Cast: Brad Pitt, Eli Roth, Diane Kruger</li>
						<li>Release: 2009</li>
						<li>Genre: Action/War</li>
						<li>Narrator Samuel L. Jackson</li>
					</ul>
					</div>
				</div>
